...
class memManager
{
	...
	protected:
		...
		virtual bool read(void* buffer,size_t* k,size_t size) const;//{return 0;} 
	...
	public:
		memManager();
		inline size_t setCurrentPosition(size_t currentPosition);
...
inline size_t memManager::setCurrentPosition(size_t currentPosition) { this->currentPosition=currentPosition; }
